...
@section ('title', trans('labels.access.users.management') . ' | ' . trans('labels.access.users.create'))
    ...
    {{ Form::open(['route' => 'admin.access.users.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) }}
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('labels.access.users.create') }}</h3>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    {{ Form::label('password', trans('validation.attributes.access.users.password'), ['class' => 'col-lg-2 control-label']) }}

                    <div class="col-lg-10">
                        {{ Form::password('password', ['class' => 'form-control', 'placeholder' => trans('validation.attributes.access.users.password')]) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->

                <div class="form-group">
                    {{ Form::label('password_confirmation', trans('validation.attributes.access.users.password_confirmation'), ['class' => 'col-lg-2 control-label']) }}

                    <div class="col-lg-10">
                        {{ Form::password('password_confirmation', ['class' => 'form-control', 'placeholder' => trans('validation.attributes.access.users.password_confirmation')]) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
                ...
                <div class="form-group">
                    <label class="col-lg-2 control-label">{{ trans('validation.attributes.access.users.send_confirmation_email') }}<br/>
                        <small>{{ trans('strings.access.users.if_confirmed_off') }}</small>
                    </label>
